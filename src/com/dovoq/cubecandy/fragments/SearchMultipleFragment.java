...
public class SearchMultipleFragment extends Fragment {
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			File[] files = zipFolder.listFiles();
			imageView.setImageBitmap(BitmapFactory.decodeFile(files[position]
					.getAbsolutePath()));
			return imageView;
		}
	}
	...
	public void recycleBitmap() {
		if (adapter != null) {
			for (int i = 0; i < adapter.getCount(); i++) {
				((BitmapDrawable) adapter.viewList.get(i).getDrawable())
						.getBitmap().recycle();
			}
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		View view = inflater.inflate(R.layout.fragment_search_multiple,
				container, false);
		return view;
	}
}